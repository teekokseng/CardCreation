...
//Map CardInfo fields to the new table columns
		...
		pstmt.setLong(2, Long.parseLong(cardInfo.getCardNumber()));
		pstmt.setNull(3, 0);  // ktkntn (No value provided, maybe a placeholder or null)
		...
		if (rowsInserted > 0) {
			System.out.println("✅ Card created and saved into database successfully!");
			return true;
		} else {
